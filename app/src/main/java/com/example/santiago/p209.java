...
public class p209 extends AppCompatActivity {
    private static final String URL_DATA_CLAS="https://seahorse2.000webhostapp.com/p_209.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.p209);
        numeros = ((GlobalClass) this.getApplication()).getGlobalArrayList();

        //Barra de la Aplicacion
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Alquileres de Locales Comerciales (" + numeros.get(9) + ")");
