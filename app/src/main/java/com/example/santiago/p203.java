...
public class p203 extends AppCompatActivity {
    private static final String URL_DATA_CLAS="https://seahorse2.000webhostapp.com/p_203.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Departamentos - Ventas (" + numeros.get(3) + ")");
