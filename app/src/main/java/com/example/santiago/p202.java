...
public class p202 extends AppCompatActivity {
    private static final String URL_DATA_CLAS="https://seahorse2.000webhostapp.com/p_202.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Casas - Ventas (" + numeros.get(2) + ")");
